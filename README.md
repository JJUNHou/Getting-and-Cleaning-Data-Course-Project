...
#### As you can see, This is helper to easily capable of understanding about this project.
#### Fist of all, you may see 'run_analysis.R' ,which is a code book for making tidy data. Those process in making tidy data followed a sequence of instructs.
